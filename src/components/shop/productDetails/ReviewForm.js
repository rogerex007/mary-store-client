        ...
        <div className="mb-12 md:mx-16 lg:mx-20 xl:mx-24"></div>
          ...
          <div className="mb-12 md:mx-16 lg:mx-20 xl:mx-24 flex flex-col">
            <div className="flex flex-col space-y-2">
              <span className="text-2xl font-medium">Agregar una reseña</span>
            ...
            <div className="mb-4">
              ...
              >
                ...
                <label
                  className="full"
                  htmlFor="star4"
                  title="Bastante bueno - 4 estrellas"
                />
                <input
                  type="radio"
                  className="rating"
                  ...
                  defaultValue={3}
                />
                <label className="full" htmlFor="star3" title="Medio bueno - 3 estrellas" />
                <input
                  type="radio"
                  className="rating"
                  id="star2"
                ...
                <label
                  className="full"
                  htmlFor="star2"
                  title="Un poco malo - 2 estrellas"
                />
                <input
                  type="radio"
                  className="rating"
            ...
            <div className="space-y-4">
              <div className="flex flex-col">
                <label htmlFor="textArea">
                  Reseña <span className="text-sm text-gray-600">*</span>
                </label>
                <textarea
